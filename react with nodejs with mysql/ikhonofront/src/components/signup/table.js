...
class table extends Component{
     ...
     onComPasswordsignupchange=(event)=>{
          this.setState({signupComPassword:event.target.value});
     }
        ...
        <td> {<input 
                    ...
                    <tr>
                         <td> {<input 
                               ...
                               class="inputs" 
                               onChange={this.onComPasswordsignupchange}></input>}</td>
                    </tr>
                    <tr>
                         <td>
                         {<button id="aa" class="willsubmit" onClick={this.onSubmitsignup}>Register</button>}
                         </td>
                    </tr>
